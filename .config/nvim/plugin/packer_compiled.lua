...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "tabout.nvim", "cmp-cmdline-history", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-buffer", "cmp-calc", "cmp-cmdline" },
