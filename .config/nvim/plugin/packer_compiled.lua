...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/rejyr/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  neotest = {
    loaded = true,
    path = "/home/rejyr/.local/share/nvim/site/pack/packer/start/neotest",
